...
<Meta title="Components/Modal/AI Docs" component={Modal} />
...
- **Don't** set both \`closeOnBackdrop={false}\` and \`closeOnEscape={false}\` unless there is a clear "Cancel" button in the footer`}</Markdown>
