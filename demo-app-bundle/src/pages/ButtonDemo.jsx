        ...
        <div className="page__examples-section">
          <div className="demo-group">
            ...
            <p className="demo-group__description">
              Import the Button component from the design system package. Make sure to import both CSS files for proper styling.
            </p>
            <div className="button-demo__code-block-wrapper">
              <CopyButton codeString={`// Import styles (required) - tokens FIRST, then styles
import '@mich8060/chg-design-system/tokens.css';
import '@mich8060/chg-design-system/styles.css';

// Option 1: Import from main package (recommended for multiple components)
import { Button } from '@mich8060/chg-design-system';

// Option 2: Import individual component directly (better tree-shaking)
import Button from '@mich8060/chg-design-system/Button';`} />
              <pre className="button-demo__code-block">
                <code className="language-javascript">{`// Import styles (required) - tokens FIRST, then styles
import '@mich8060/chg-design-system/tokens.css';
import '@mich8060/chg-design-system/styles.css';
...
// Option 2: Import individual component directly (better tree-shaking)
import Button from '@mich8060/chg-design-system/Button';`}</code>
              </pre>
            </div>
          </div>
          ...
          <div className="demo-group">
            ...
            <div className="button-demo__code-block-wrapper">
              <CopyButton codeString={`import { Button } from '@mich8060/chg-design-system';
...
/>`} />
              <pre className="button-demo__code-block">
                <code className="language-jsx">{`import { Button } from '@mich8060/chg-design-system';
...
// No need to specify iconSize when using icon prop with string`}</code>
          ...
          <div className="demo-group">
            ...
            <div className="button-demo__code-block-wrapper">
              <CopyButton codeString={`import { Button, Icon } from '@mich8060/chg-design-system';
...
/>`} />
              <pre className="button-demo__code-block">
                <code className="language-jsx">{`import { Button, Icon } from '@mich8060/chg-design-system';
          ...
          <div className="demo-group">
            <div className="page__navigation">
              ...
              >
                ...
                <span className="page__nav-title">Calendar</span>
              </Link>
            </div>
          </div>
        </div>
